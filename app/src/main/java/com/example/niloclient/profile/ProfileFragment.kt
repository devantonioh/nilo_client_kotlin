package com.example.niloclient.profile
...
import com.example.niloclient.databinding.FragmentProfileBinding
    ...
    private fun updateUserProfile(binding: FragmentProfileBinding, user : FirebaseUser, uri: Uri) {
        ...
        user.updateProfile(profileUpdated)
            ...
            .addOnFailureListener {
                Toast.makeText(activity, "Error al actualizar el usurio.", Toast.LENGTH_SHORT)
                    .show()
            }
    }
